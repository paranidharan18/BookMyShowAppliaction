...
public class AgsBookingDetailsResponse {
	...
	public AgsBookingDetailsResponse() {
	}

	public AgsBookingDetailsResponse(String movieName, String bookingStatus, String bookingDateAndTime,
